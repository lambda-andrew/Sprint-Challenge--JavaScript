...
for(i = 0; i < graduates.length; i++){
  let strUni = graduates.university.toString();
  console.log(strUni);
}
...
zooAnimals.forEach(function(item, array){
...
const noCaps = zooAnimals.map(function(currentValue){
  return currentValue.animal_name.toLowerCase();
});

lowerCase.push(noCaps);
...
*/
const populationTotal = zooAnimals.reduce(function(accumulator, currentVal){
