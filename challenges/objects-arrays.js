...
console.log(cretassic.tyrannosaurus.weight + "kg");

// What was the diet of a velociraptor?
console.log(cretassic.velociraptor.diet);

// How long was a stegosaurus?
console.log(cretassic.stegosaurus.length + "m");

// What time period did tyrannosaurus live in?
console.log(cretassic.tyrannosaurus.period);


// Create a new roar method for the tyrannosaurus.  When called, return "RAWERSRARARWERSARARARRRR!" Log the result.
console.log(cretassic.tyrannosaurus.roar());
...
*/
const animalNames = [];
zooAnimals.forEach(function(myArr) {
...
const lowerCase = zooAnimals.map(function(myArr) {
...
*/
const largerPopulation = zooAnimals.filter(function(myArr) {
  return myArr.population < 5;
});
...
*/
const populationTotal = zooAnimals.reduce(function(totalPopulation, myArr) {
